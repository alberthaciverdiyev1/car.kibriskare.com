...
use App\Filament\Agency\Resources\CarResource\Pages;
...
class CarResource extends Resource
{
    ...
    protected static ?string $navigationLabel = 'Avtomobil Elanlarım';

    protected static ?string $modelLabel = 'Avtomobil Elanı';

    protected static ?string $pluralModelLabel = 'Avtomobil Elanlarım';
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        return parent::getEloquentQuery()
            ->where(function (Builder $query) use ($user, $autosalonId) {
                $query->where('user_id', $user?->id);
                if ($autosalonId) {
                    $query->orWhere('autosalon_id', $autosalonId);
                }
            });
    }
