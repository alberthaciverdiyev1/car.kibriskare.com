...
@section('title', __('favorites.page_title') . ' - araba.kibriskare.com')
...
<div class="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8 pb-4 border-b border-gray-200">
        <div class="flex items-center gap-3">
            ...
            <div>
                <div class="flex items-center gap-2">
                    ...
                    <span id="favsTotalBadge" class="{{ count($cars) > 0 ? '' : 'hidden' }} px-2.5 py-0.5 rounded-full text-xs font-semibold bg-orange-100 text-orange-600">
                        {{ count($cars) }}
                    </span>
                </div>
            </div>
        ...
        <div id="favsActions" class="{{ count($cars) > 0 ? '' : 'hidden' }} flex items-center gap-3">
    ...
    <!-- Empty State -->
    <div id="favsEmptyState" class="{{ count($cars) === 0 ? '' : 'hidden' }} text-center py-16 px-4 bg-white rounded-3xl border border-gray-100 shadow-sm max-w-lg mx-auto">
