<div id="modal-advance"
    ...
    <div class="bg-white rounded-3xl shadow-2xl max-w-sm w-full mx-auto relative p-6 flex flex-col space-y-4 border border-gray-100">
        <div class="flex items-center justify-between pb-2 border-b border-gray-100">
            ...
            <button type="button" class="w-8 h-8 rounded-full bg-gray-100 hover:bg-gray-200 text-gray-500 hover:text-gray-800 text-lg font-bold flex items-center justify-center cursor-pointer" data-close="modal-advance">&times;</button>
        </div>
        ...
        <div class="flex flex-col space-y-2">
            <label class="flex items-center justify-between p-3 border border-gray-200 rounded-2xl hover:border-emerald-500 hover:bg-emerald-50/30 cursor-pointer text-sm font-semibold group">
